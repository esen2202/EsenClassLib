...
//
/*   // Aşağıdaki Kodu Kullandığında içerisine yazılan dosya veya klasörü seçilmiş halde dizini açar.s
     ShowSelectedInExplorer.FilesOrFolders(
                @"C:\Users\erkan\Downloads\WPF Skinning App in Blend\Skinning_Demo.docx",
                @"C:\Users\erkan\Downloads\WPF Skinning App in Blend\Skinning_Demo.zip",
                @"C:\Users\erkan\Downloads\JAPONCA"
                );
...
namespace EsenClassLib
{
    ...
    public static class ShowSelectedInExplorer
    {
        ...
        class NativeMethods
        {
            ...
            static extern int SHOpenFolderAndSelectItems_([In] IntPtr pidlFolder, uint cidl, [In, Optional, MarshalAs(UnmanagedType.LPArray)] IntPtr[] apidl, int dwFlags);
